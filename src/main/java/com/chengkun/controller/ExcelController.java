...
public class ExcelController {
    ...
    public void exportExcelByStyle(HttpServletResponse response) {
        ...
        ExcelUtils.exportExcel(personList, "easypoi导出样式功能", "Export", InsightIec104Mapping.class, "excel样式测试.xls", ExportExcelStyle.class, response);
    }
    ...
    public void exportExcelByMap(HttpServletResponse response) {
        ...
        ExcelUtils.exportExcel(list, "easypoi导出map功能", "Export", colList, "easypoi导出map功能.xls", ExportExcelStyle.class, response);
    }
    ...
    public void exportExcelByComposite(HttpServletResponse response) {
        ...
        // 把我们构造好的bean对象放到params就可以了
        ExcelUtils.exportExcel(list, "easypoi导出复合标题", "Export", colList, "easypoi导出复合标题.xls", ExportExcelStyle.class, response);
    }

    @ApiOperation(value = "Excel导出多sheet页,自定义标题")
    @GetMapping("/exportExcelBySheets")
    public void exportExcelBySheets(HttpServletResponse response) {
        ...
        exportParams1.setStyle(ExportExcelStyle.class);
        ExportParams exportParams2 = new ExportParams("遥测", "遥测");
        exportParams2.setStyle(ExportExcelStyle.class);
    ...
    @GetMapping("/exportExcelBySheets1")
    ...
    public String importExcelByMap(HttpServletResponse response) {
        ...
        importParams.setDataHandler(new MapImportHandler(Maps.newLinkedHashMap()));
        try {
            long start = System.currentTimeMillis() / 1000;
            ExcelImportResult<Object> result = ExcelImportUtil.importExcelMore(
                    new FileInputStream("E:\\google_downloads\\IEC测点映射20200317102927.xls"), Map.class, importParams);
    ...
    @GetMapping("/importExcelBySaxAndEntity")
    public String importExcelBySaxAndEntity(HttpServletResponse response) {
        ImportParams importParams = new ImportParams();
        // 数据处理
        importParams.setHeadRows(1);
        importParams.setTitleRows(1);
        ...
        try {
            ...
            ExcelImportUtil.importExcelBySax(
                    new FileInputStream(
                            new File("E:\\google_downloads\\IEC测点映射20200317102927.xlsx")),
    ...
    public String importExcelBySax(HttpServletResponse response) {
        ...
        try {
            long start = System.currentTimeMillis() / 1000;
            new SaxReadExcel().readExcel(new FileInputStream(
                            new File("E:\\google_downloads\\06DCE110.xlsx")),
                    Map.class, importParams, new IReadHandler<Map<String, Object>>() {
